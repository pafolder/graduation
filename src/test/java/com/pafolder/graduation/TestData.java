...
public class TestData {
    ...
    public static final User user = new User(0, "John Smith", "johnsmith@mail.net", DEFAULT_PASSWORD,
            true, User.Role.USER);
    public static final User updatedUser = new User(0, "Novoivanov", "newmail@nm.com", DEFAULT_PASSWORD,
    ...
    public static final User admin = new User(4, "Администратор", "admin@mail.com",
